...
export function generateCoachCards(
    ...
    if (trades.length === 0) {
        cards.push({
            ...
            message: "Welcome to The Perfect Trader. Log your first trade today to initialize my pattern-recognition engine. I'll transform your execution data into a high-fidelity discipline roadmap.",
            tone: 'encouraging',
            priority: 0,
            timestamp: now,
            type: 'session_start'
