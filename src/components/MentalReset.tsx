...
export default function MentalReset({ isOpen, onClose }: MentalResetProps) {
    ...
    return (
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    className="fixed inset-0 z-[200] bg-white flex flex-col p-6 pb-[calc(env(safe-area-inset-bottom)+20px)] sheet-scroll"
                                ...
                                >
                                    <div className="flex flex-col gap-4">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-40 bg-gray-50 rounded-lg p-6 text-[17px] font-bold text-[#1a1a2e] border-none outline-none resize-none shadow-inner"
                                        />
                                    </div>
