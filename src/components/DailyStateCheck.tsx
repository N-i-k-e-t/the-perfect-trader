...
export default function DailyStateCheck() {
    const { session, completePreSession, setEmotionalBaseline } = usePerfectTrader();
    ...
    return (
        <div className="fixed inset-0 z-[200] bg-white flex flex-col p-6 pb-[calc(env(safe-area-inset-bottom)+20px)] overflow-y-auto">
            ...
            <footer className="pt-8 mb-4">
                ...
                <p className="text-[11px] font-bold text-gray-300 text-center mt-6 uppercase tracking-[0.2em]">The Perfect Trader Discipline Shield Active</p>
            </footer>
        </div>
    );
}
