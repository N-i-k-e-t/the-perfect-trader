...
export default function InstallPrompt() {
    ...
    useEffect(() => {
        ...
        if (isIOS && !isStandalone) {
            const dismissed = localStorage.getItem('perfect_trader_pwa_dismissed');
            if (!dismissed) {
                setShow(true);
            }
        }
    ...
    const dismiss = () => {
        localStorage.setItem('perfect_trader_pwa_dismissed', 'true');
        setShow(false);
    };
            ...
            {show && (
                ...
                >
                    ...
                    <div className="flex flex-col items-center text-center">
                        ...
                        <h3 className="text-lg font-black text-[#1a1a2e] mb-2">Install The Perfect Trader</h3>
