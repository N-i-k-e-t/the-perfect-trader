    ...
    useEffect(() => {
        const timer = setInterval(() => {
            setTimeLeft((prev) => {
                ...
                localStorage.setItem('The Perfect Trader_pricing_timer', next.toString());
                return next;
            });
        }, 1000);
                    ...
                    >
                        ...
                        >
                            <div className="w-full h-full bg-white rounded-[32px] overflow-hidden relative shadow-inner">
                                <img 
                                    src="/mockup-hero.png" 
                                    alt="The Perfect Trader Dashboard Mockup" 
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
                            ...
                            {[
                                ...
                                { 
                                    ...
                                    desc: "The Perfect Trader AI grades your discipline score and identifies performance-killing patterns you don't even see.", 
                ...
                <section className="py-24 bg-[#1a1a2e] text-white overflow-hidden relative">
                    ...
                    <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
                        ...
                        <p className="text-[18px] md:text-[22px] font-medium text-white/60 leading-relaxed mb-12">
                            A spreadsheet can't stop a revenge trade. A notebook can't grade your emotional state. The Perfect Trader calculates the exact <span className="text-white">cost of your indiscipline</span> and builds a habit of compliance.
                        </p>
                            ...
                            {[
                                {
                                    ...
                                    quote: "I used to overtrade every Thursday. The Perfect Trader showed me I was losing 1.2L a month to greed alone. Fixed it in two weeks.",
                                    grade: "B → A+"
                                },
                                {
                                    name: "Sarah Chen",
                            ...
                            {[
                                {
                                    ...
                                    desc: "You have a solid strategy, but one loss sends you into a revenge trade cycle. The Perfect Trader's 'Hard Stop' protocol prevents the second impulsive entry.",
                                    icon: <Zap />
                                },
                                {
                        ...
                        <div className="flex flex-col gap-4">
                            {[
                                ...
                                { 
                                    ...
                                    a: "No. The Perfect Trader is focused on DISCIPLINE, not just bookkeeping. By manually logging (which takes 3 taps), you build self-awareness and accountability that automated trackers cannot provide." 
                                },
                                { 
                                    q: "Can I use it for Crypto, Stocks, or Options?", 
                                    a: "Yes. The The Perfect Trader protocol is asset-agnostic. Whether you trade Bank Nifty options, Bitcoin, or US Tech stocks, you can track your rules and compliance here." 
                                },
                                { 
                                ...
                                { 
                                    ...
                                    a: "An A-Grade day doesn't necessarily mean you made money. It means you followed 100% of your rules without deviation. In The Perfect Trader, following rules is more important than the P&L." 
                                }
                            ].map((faq, i) => (
                ...
                <section className="py-24 px-6 bg-gray-50 overflow-hidden">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            ...
                            <h3 className="text-[38px] font-black tracking-tighter">Why The Perfect Trader?</h3>
                        </div>
                            ...
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-gray-50">
                                        ...
                                        <th className="p-8 text-[14px] font-black text-[#1a1a2e] text-center bg-blue-50/50">The Perfect Trader</th>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 sm:gap-24 mb-24">
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 mb-8">
                            ...
                            <span className="text-[22px] font-black tracking-tight text-white">The Perfect Trader</span>
                        </div>
                    ...
                    <div className="bg-white/5 p-8 rounded-[32px] border border-white/10 relative overflow-hidden group">
                        ...
                        <form className="relative z-10" onSubmit={(e) => { e.preventDefault(); alert('Subscribed to The Perfect Trader Labs!'); }}>
                            <input 
                                required
                                type="email" 
