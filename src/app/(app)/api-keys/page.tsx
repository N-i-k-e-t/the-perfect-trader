            ...
            <div className="p-6 bg-[#1a1a2e]/5 border border-[#1a1a2e]/10 rounded-3xl flex items-start gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-[#6b7280] leading-relaxed">
                        The Perfect Trader stores all your keys safely on your device. We never see your data. This ensures absolute privacy, but means you must re-enter keys if you clear your browser cache.
                    </p>
                </div>
            </div>
        </div>
